...
function App() {
  const downloadLink = "https://github.com/PixelsofArya/YOUR_REPO_NAME/releases/latest/download/OHAssistant.exe";
      ...
      <main className="main-content">
        ...
        <section className="download-section solid-panel">
          ...
          <div className="download-actions">
            <a href={downloadLink} className="download-btn" download="OHAssistant.exe">
